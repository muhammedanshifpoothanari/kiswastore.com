...
import { Upload, CheckCircle2, Gift, MapPin, Phone, User, ChevronRight, HelpCircle } from 'lucide-react'
...
export default function OfferPage({ params }: PageProps) {
  ...
  const sectors = [
    ...
    { label: 'Sponge Prayer Mat 🎁', color: '#2d5f4f' }, // Brand Teal (Winner!)
  ...
  const handleSpinWheel = () => {
    ...
    // Calculate rotation to land exactly in the middle of sector 3 (Sponge Prayer Mat)
    // Formula: 360 * number_of_spins + angle_for_sector_3
    // Angle for sector 3 center is 150 degrees
    const totalSpins = 6
      ...
      <main className="flex-grow max-w-4xl mx-auto w-full px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2 max-w-lg mx-auto">
            Scan your QR code, upload your purchase bill, spin the lucky wheel, and receive a premium gift at your doorstep!
          </p>
        </div>
        ...
        {/* Main Content Area */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden max-w-2xl mx-auto">
          ...
          {step === 'lottery' && (
            <div className="p-6 md:p-8 flex flex-col items-center">
              ...
              <p className="text-xs text-gray-500 text-center mb-8 max-w-sm">
                Your receipt has been received. Spin the Kiswa Campaign Wheel to see your gift.
              </p>
                ...
                <div className="text-center w-full max-w-md space-y-5 animate-[fadeIn_0.5s_ease-out]">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-700 mt-1.5">
                      You won a <span className="text-[#8c763e] underline decoration-[#8c763e] decoration-2">Premium Sponge Prayer Mat</span>!
                    </p>
                  </div>
                  <p className="text-xs text-gray-500">
                    Submit your delivery details below so we can ship the Sponge Prayer Mat directly to your home once the bill is verified.
                  </p>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="bg-amber-50 border border-amber-200/50 rounded-xl p-3.5 mb-6">
                <p className="text-[11px] text-amber-800 leading-relaxed font-semibold text-center">
                  🚚 Note: We will deliver your Sponge Prayer Mat only after we review and verify the bill you submitted.
                </p>
              </div>
            ...
            <div className="p-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 max-w-sm mx-auto leading-relaxed">
                  Thank you! We will review and verify your purchase bill shortly. Once approved, your Premium Sponge Prayer Mat will be delivered directly to your home at:
